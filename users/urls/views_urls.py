...
urlpatterns = [
    ...
    path('user/<int:pk>/assets/', views.UserGrantedAssetView.as_view(), name='user-granted-asset'),
    path('user/<int:pk>/login-history/', views.UserDetailView.as_view(), name='user-login-history'),

    # User group view
    path('user-group/', views.UserGroupListView.as_view(), name='user-group-list'),
    path('user-group/<int:pk>/', views.UserGroupDetailView.as_view(), name='user-group-detail'),
    path('user-group/create/', views.UserGroupCreateView.as_view(), name='user-group-create'),
    path('user-group/<int:pk>/update/', views.UserGroupUpdateView.as_view(), name='user-group-update'),
    path('user-group/<int:pk>/assets/', views.UserGroupGrantedAssetView.as_view(), name='user-group-granted-asset'),
