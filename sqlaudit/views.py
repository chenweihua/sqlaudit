...
from users.models import User,Tsession
...
class IndexView(LoginRequiredMixin, TemplateView):
    ...
    def get_user_disabled_total():
        ...
        return User.objects.filter(is_active=False).all().count()
    ...
    def get_context_data(self, **kwargs):
        ...
        self.session_week = Tsession.objects.filter(date_start__gt=week_ago)
        self.session_month = Tsession.objects.filter(date_start__gt=month_ago)
